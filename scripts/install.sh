...
echo "    # Terminal 1 — start the dashboard"
echo "    agentviz server start                  # local only (http://localhost:8787)"
echo "    agentviz server start --remote         # expose to Tailscale/LAN"
echo ""
echo "    # Terminal 2 — run an agent"
echo "    agentviz run -w <WORKSPACE> claude     # Claude Code"
echo "    agentviz run -w <WORKSPACE> gemini     # Gemini CLI"
echo "    agentviz run -w <WORKSPACE> codex      # Codex CLI"
echo ""
echo "    # Stop the dashboard when done"
echo "    agentviz server stop"
echo ""
